...
export default async function InspectionDetailPage({ params }: PageProps<"/inspections/[id]">) {
    ...
    return (
        <div className="form-control">
            <h1 className="form-title">Inspection — {inspection.properties.name}</h1>

            <div className="space-y-2 mb-6">
                <div>
                    <strong>Inspector:</strong> {inspection.users?.name}
                </div>
                <div>
                    <strong>Date:</strong> {inspection.date}
                </div>
                <div>
                    <strong>Roof Type:</strong> {inspection.roof_type}
                </div>
                <div>
                    <strong>Notes:</strong> {inspection.summary_notes}
                </div>
            </div>
